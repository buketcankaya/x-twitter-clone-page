    ...
    <div className="flex gap-3 p-3 border-b-[1] border-gray-600">
      ...
      <div className="w-full">
        ...
        <div className="flex justify-between">
          ...
          {/* kullanıcı id eşitse silebilmek için  */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-1 items-center p-2 px-3 rounded-full transition cursor-pointer ">
            <BiMessageRounded />
          ...
          <div
            onClick={toggleLike}
            className="flex gap-1 items-center p-2 px-3 rounded-full transition cursor-pointer hover:bg-[#d74c503c] "
          >
